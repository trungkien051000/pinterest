...
back.setOnClickListener(new View.OnClickListener() {
    ...
    private List<Anhtrangcanhan> getListAnhTCN() {
        ...
        list.add(new Anhtrangcanhan(R.drawable.ha, ""));
        list.add(new Anhtrangcanhan(R.drawable.ha1, ""));
        list.add(new Anhtrangcanhan(R.drawable.ha2, ""));
        list.add(new Anhtrangcanhan(R.drawable.a9, ""));
        list.add(new Anhtrangcanhan(R.drawable.ha4, ""));
        list.add(new Anhtrangcanhan(R.drawable.ha5, ""));
        list.add(new Anhtrangcanhan(R.drawable.ha6, ""));
